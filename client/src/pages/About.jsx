...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-100 py-6 md:py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-8 space-y-6 md:space-y-8">
